...
public class AccountService {
    ...
    return accountApi.getAccount(accountId,apiProperties.getRequestOptions());
    }
    public Iterator<Bundle> getAccountBundles(final UUID accountId) throws KillBillClientException {
        Bundles bundles = accountApi.getAccountBundles(accountId, null,  null,apiProperties.getRequestOptions());
        return bundles.iterator();
    }
    public void updateAccount(UUID accountId, Account account) throws KillBillClientException {
        accountApi.updateAccount(accountId, account, apiProperties.getRequestOptions());
    }
